...
//
const BotName = 'LBOT'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/LKY_DESIGN'; // Nama Instagramlu cok
const whatsapplu = '085235664215'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by L`))
...
conn.sendMessage(id, '3aalaikumsalam, Ketik #listcok/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, Ketik #listcok/#info/#donasi Contoh #listcok' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, Ketik #listcok/#info/#donasi Contoh #listcok' ,MessageType.text);
}
else if (text == 'Halo'){
conn.sendMessage(id, 'Ya?, Ketik #listcok/#info/#donasi Contoh #listcok' ,MessageType.text);
}
...
conn.sendMessage(id, 'Test 1,2,3 ketik #listcok' ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Ya?, Ketik #listcok/#info/#donasi Contoh #listcok' ,MessageType.text);
}
